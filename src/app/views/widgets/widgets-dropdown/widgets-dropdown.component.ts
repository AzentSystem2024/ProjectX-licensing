...
export class WidgetsDropdownComponent implements OnInit, AfterContentInit {
  ...
  constructor(
    private changeDetectorRef: ChangeDetectorRef,private service:MyserviceService,private router:Router
  ) {}
  dashboardvalue:any;
  data: any[] = [];
  options: any[] = [];
  ...
  getDashboardValue(): void {
    this.service.getDashboardValue().subscribe(data => {
     this.dashboardvalue=data;
    });
  }
  navigateToProductPage(){
    this.router.navigate(['/activity/license']);
  }
